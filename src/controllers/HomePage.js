    ...
    view: function() {
      return `
        <div style="width: 100%; height: 100%; margin: 0; padding: 0;">
         <div style="font-family: arial; width: 500px; justify-content: center; text-align: center; margin: 7% auto 0 auto;">
            <svg class="logo" width="100px" height="180px" viewBox="0 0 64 64" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="icons8_synchronize_2">
                  <path d="M12.5714 25.1429C19.5029 
                  25.1429 25.1429 19.5029 25.1429 12.5714C25.1429 5.64 19.5029 0 12.5714 0C5.64 0 0 5.64 0 12.5714C0 19.5029 5.64 25.1429 12.5714 25.1429L12.5714 25.1429ZM12.5714 2.28571C18.2434 2.28571 22.8571 6.89943 22.8571 12.5714C22.8571 18.2434 18.2434 22.8571 12.5714 22.8571C6.89943 22.8571 2.28571 18.2434 2.28571 12.5714C2.28571 6.89943 6.89943 2.28571 12.5714 2.28571L12.5714 2.28571Z" transform="translate(19.42857 19.42743)" id="Shape" fill="url(#gradient_1)" stroke="none" />
            ...
            <p><mark>iVuer.js</mark> is an Open Source MVC FromeWork build using JavaScript</p>
            <p>For a guide or more information on how to use and configure your project vist the documentation</p>
            
            <a href="http://iVuer.js/docs">https://iVuer.js/docs</a>
         </div>
         </div>
